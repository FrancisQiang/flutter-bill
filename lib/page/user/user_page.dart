...
class UserPage extends StatelessWidget {
  ...
  Widget _getBottomSheetButton({@required String content, @required BuildContext context, Function function}) {
    return InkWell(
      onTap: function,
      child: Container(
        ...
        children: <Widget>[
                      ...
                      child: Hero(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Colors.grey[200], width: 3.3),
                          ),
                        ),
                      ),
                    )
          ...
          Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  SizedBox(
                    height: ScreenUtil.getInstance().setHeight(3200),
                  )
                ],
              ))
        ],
